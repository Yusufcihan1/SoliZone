   ...
   <div className="flex mt-2">
    <div className=" flex ">
     <button
      ...
      className="mr-2 text-white bg-blue-700 hover:bg-green-900  transition-colors duration-300 font-medium rounded-lg text-sm  px-3  text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 "
      type="button">
